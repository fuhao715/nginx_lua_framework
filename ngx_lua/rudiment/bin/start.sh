...
#export FUHAO_NGX_LUA_HOME=/YOUR PATH/fuhao_ngx_lua
#export HADDIT_APP_CONFIG=/YOUR PATH/new_reddit/haddit.config


FUHAO_NGX_LUA_APP_EXTRA=$PWD

sed -e "s|__FUHAO_NGX_LUA_HOME_VALUE__|$FUHAO_NGX_LUA_HOME|" \
    -e "s|__FUHAO_NGX_LUA_APP_PATH_VALUE__|$APP_PATH|" \
    -e "s|__FUHAO_NGX_LUA_APP_NAME_VALUE__|$APP_NAME|" \
