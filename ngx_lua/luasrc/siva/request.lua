...
module('fuhao.request',package.seeall)
...
function Request:new()
    ...
    local ngx_upload = require("fuhao.upload") 
    local up_data = ngx_upload.FuhaoUpload:new()
    local ret = {
...
getmetatable(fuhao.request).__newindex = function (table, key, val)
